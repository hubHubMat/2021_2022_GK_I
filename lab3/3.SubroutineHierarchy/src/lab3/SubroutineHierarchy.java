...
public class SubroutineHierarchy extends JPanel {
	...
	private void drawWorld(Graphics2D g2) {
		...
		subScene(g2);  // (DELETE THIS EXAMPLE)
	...
	private void subScene(Graphics2D g2) { // (DELETE THIS EXAMPLE)
        ...
        g2.translate(-3, 2.3);
        g2.rotate( Math.toRadians( frameNumber*0.6 ));
       ...
       // g2.translate(-3, 2.3);
        ...
        g2.draw( new Line2D.Double( -3, 2.3, 
        							-1, 2	) );
...
// Set 2
       ...
       // g2.translate(-3, 2.3);
        ...
        g2.draw( new Line2D.Double( 1, 1.8, 
        							3, 1.5	) );
