...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void Pyramid(GL2 gl2){
        ...
        for (int i = 1; i <= numVertices; i++) {
            ...
            x2 = (float) (radius * Math.sin(angle));

            gl2.glMaterialfv( GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, purple, 0 );
            gl2.glVertex3f( x1, -2.0f, x2 );

            gl2.glMaterialfv( GL2.GL_FRONT, GL2.GL_SPECULAR, white, 0 );
